...
contract EmploymentContract is ReentrancyGuard {
    ...
    address public employee = 0xc7abb2c5f3bf3ceb389df0eecd6120d451170b50;
    address private authorizedApp; // Address of the authorized app to update metrics
    uint256 public salary = 11666; // Monthly salary amount in USDC
    IERC20 private usdcToken; // USDC token contract interface
    uint256 public startDate = 126230400; // Unix timestamp of Tue Jan 01 1974 00:00:00 GMT+0000 (Greenwich Mean Time)
    uint256 public terminationDate = 2543094000; // Unix timestamp of Wed Aug 03 2050 00:00:00 GMT+0100 (British Summer Time)
