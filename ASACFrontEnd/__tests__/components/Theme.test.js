...
//        SecureStore.getItemAsync.mockResolvedValue('light'); // Set initial state
//        const wrapper = ({ children }) => <ThemeProvider>{children}</ThemeProvider>;
//        
//        await act(async () => {
//            const { result, waitForNextUpdate } = renderHook(() => React.useContext(ThemeContext), { wrapper });
//            await waitForNextUpdate(); // Wait for effect
//            result.current.toggleTheme(); // Toggle theme
//            await waitForNextUpdate(); // Wait for async setItem
//        });
//
//        const { result } = renderHook(() => React.useContext(ThemeContext), { wrapper });
//        expect(result.current.theme).toBe('dark');
...
//        await act(async () => {
//            const { result, waitForNextUpdate } = renderHook(() => React.useContext(ThemeContext), { wrapper });
//            await waitForNextUpdate(); // Wait for initial theme set
//            result.current.toggleTheme(); // Toggle theme
//            await waitForNextUpdate(); // Wait for async setItem
//        });
//
...
//        await act(async () => {
//            const { result, waitForNextUpdate } = renderHook(() => React.useContext(ThemeContext), { wrapper });
//            await waitForNextUpdate(); // Wait for the effect
