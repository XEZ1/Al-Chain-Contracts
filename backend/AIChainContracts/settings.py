"""
Django settings for AIChainContracts project.
...
ROOT_URLCONF = 'AIChainContracts.urls'
...
WSGI_APPLICATION = 'AIChainContracts.wsgi.application'

# Location of the ASGI application
ASGI_APPLICATION = 'AIChainContracts.asgi.application'
